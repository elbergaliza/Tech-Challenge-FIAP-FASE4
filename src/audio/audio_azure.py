...
def transcribe_audio(
    ...
    *,
    ...
    try:
        ...
        if exc.error_code == ErrorCode.MISSING_AZURE_CONFIGURATION:
            LOGGER.warning("audio_azure_speech_missing_credentials")
...
def analyze_text_findings(
    ...
    *,
    ...
    try:
        ...
        if exc.error_code == ErrorCode.MISSING_AZURE_CONFIGURATION:
            LOGGER.warning("audio_azure_text_missing_credentials")
            return TextFindings(sentiment=SentimentLabel.UNKNOWN)
        raise
    ...
    try:
        ...
        critical_terms = find_critical_terms(searchable_text, language=language)
